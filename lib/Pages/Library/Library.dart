...
import 'package:sql_sample/Pages/Library/Widgets/BookViewer.dart';

class Library extends StatefulWidget {
  final Map<String,dynamic> data;
  Library({Key? key, required this.data}) : super(key: key);
...
class _LibraryState extends State<Library> {
  ...
  void fetch_data() async{
    ...
    Uri url = Uri.parse('https://sgvamcbailhongal.org/cms/api/student/libraray.php');
    bool login = false;

// Create a Map to hold the query parameters
    final Map<String, String> body2 = {
      "stud_id": widget.data['id'],
    };
